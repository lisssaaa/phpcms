...
<html xmlns="http://www.w3.org/1999/xhtml">
 <head> 
  ...
  <link rel="stylesheet" href="mystatic/list/css/2013_base_1.css" /> 
  <link rel="stylesheet" href="mystatic/list/css/2013_mainbusiness_1.css" /> 
  <script src="mystatic/list/js/2013_modernizr-2.5.3.min_1.js"></script> 
  <script src="mystatic/list/js/2013_jquery-1.7.1.min_1.js"></script> 
  <script src="mystatic/list/js/2013_main_1.js"></script> 
  <script src="mystatic/list/js/2013_scroll_1.js"></script> 
  <script src="mystatic/list/js/2013_gototop_1.js"></script>
  <style>
...
function createPageHTML(_nPageCount, _nCurrIndex, _sPageName, _sPageExt){
    ...
    var news_line = "<td height=1 background=mystatic/list/images/news_linebg_1.gif></td>";//浅线
...
　　if(parseInt(_nPageCount)>=1){
 ...
 <body> 
  ...
  <style type="text/css">
    ...
    .logo a{display:inline-block;width:100px;height:50px;background:url("mystatic/list/images/logo_80th_new_1.png") left top no-repeat;}
    .logo .logo-80th{
  ...
  <div class="other-topimg" id="featured"> 
   <div id="slider"> 
    <ul id="sliderContent"> 
     <li class="sliderImage"><em class="img-top-bg"></em><img src="mystatic/list/picture/2013_news_f01_1.jpg" width="1920" height="320" alt="" /><span></span></li> 
    </ul> 
   </div> 
  </div>  
  <!--end other-topimg-->
...
<!--end othersmenu--> 
    ...
    <?php if($r[parentid] == 0) { ?>
        ...
        <?php $n=1;if(is_array($data)) foreach($data AS $rr) { ?>
          ...
          <?php $n=1;if(is_array($data)) foreach($data AS $n) { ?>  
            <li> 
                <div class="time">
                  <span class="day"><?php echo date('d',$n['inputtime']);?></span>
                  <span class="date"><?php echo date('Y-m',$n['inputtime']);?></span>
                </div>          
                <div class="conts"> 
                  <h3>
                  <a href="<?php echo $n['url'];?>" target="_blank"><?php echo $n['title'];?></a>
                  </h3> 
                  <p><?php echo $n['description'];?><a class="more" href="<?php echo $n['url'];?>" target="_blank"><img src="mystatic/list/picture/2013_i08_1.gif" alt="更多" /></a></p> 
                </div>        
            </li>
          <?php $n++;}unset($n); ?>
          <?php if(defined('IN_ADMIN') && !defined('HTML')) {echo '</div>';}?>
        ...
        <?php if(defined('IN_ADMIN') && !defined('HTML')) {echo '</div>';}?>
    <?php } else { ?>
        <?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"get\" data=\"op=get&tag_md5=dfd3310df905301dd7753348edd11639&sql=select+%2A+from+v9_news+where+catid%3D%24_GET%5Bcatid%5D&num=2&page=%24_GET%5Bpage%5D\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">编辑</a>";}pc_base::load_sys_class("get_model", "model", 0);$get_db = new get_model();$pagesize = 2;$page = intval($_GET[page]) ? intval($_GET[page]) : 1;if($page<=0){$page=1;}$offset = ($page - 1) * $pagesize;$r = $get_db->sql_query("SELECT COUNT(*) as count FROM (select * from v9_news where catid=$_GET[catid]) T");$s = $get_db->fetch_next();$pages=pages($s['count'], $page, $pagesize, $urlrule);$r = $get_db->sql_query("select * from v9_news where catid=$_GET[catid] LIMIT $offset,$pagesize");while(($s = $get_db->fetch_next()) != false) {$a[] = $s;}$data = $a;unset($a);?>
          <?php $n=1;if(is_array($data)) foreach($data AS $n) { ?>  
            <li> 
                <div class="time">
                  <span class="day"><?php echo date('d',$n['inputtime']);?></span>
    ...
    <?php } ?>
      ...
      <div class="pages"> 
       <span class="box btnpre">
        <?php echo $pages;?>
        <!-- <script>createPageHTML(2, 0, "index", "htm");</script>  -->
       </span> 
      </div>
      <!--end pages--> 
     </div>
   ...
   <div class="footer"> 
    ...
    <!--   <div class="btm"><img src="mystatic/list/picture/2013_cn_1.gif" alt="统计" /></div> --> 
   </div>
   <!--end footer--> 
   <script src="mystatic/list/js/dma_1.js" type="text/javascript"></script> 
   <script>
var _hmt = _hmt || [];
(function() {
  ...
  <script src="mystatic/list/js/2013_jianfan_1.js" type="text/javascript"></script>
 </body>
</html>